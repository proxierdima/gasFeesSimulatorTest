...
3. ✅ Wait for transaction confirmation (may take 5-10 minutes)
...
**Solution**: Ensure `HARNESS_PRIVATE_KEY` is set in the `.env` file
...
Open a second terminal and monitor the log:
...
This is normal! Transaction is being processed.
...
### Timeout (But Transaction May Succeed)
...
❌ Insufficient gas (may be expected for some scenarios)
